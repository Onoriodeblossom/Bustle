...
import {SubExpenseHistoryList} from './SubHistory/SubExpenseHistoryList';

export const ExpandableExpenseHistoryList = ({
  item,
  onClickFunction,
  toggleOverlay,
}) => {
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        ...
        style={styles.header}>
        <Text style={styles.headerText}>{item.dateDescription}</Text>
      </TouchableOpacity>
      <View
        style={{
          height: layoutHeight,
        ...
        <View style={{height: 40, flexDirection: 'row', marginBottom: 10}}>
          ...
          <View
            ...
            <Text style={{fontWeight: 'bold'}}>{item.totalAmount}</Text>
          </View>
        </View>
