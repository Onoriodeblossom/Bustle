...
const ExpenseType2ListScreen = ({ navigation }) => {
    ...
    const LoadExpense = (value) => {
        setLoading(true);
        fetch(`http://bustle.ticketplanet.ng/GetExpenseType2/${value}`, {
            method: 'Get',
            headers: {
    ...
    const editItem = (item) => {
        navigation.navigate('AddExpenseType2Screen', { id: item.id })
    };
    const DeleteExp = (id) => {
        setLoading(true);
            ...
            <View style={styles.mainBody} >
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <TouchableOpacity activeOpacity={0.5} onPress={() =>
                        navigation.navigate('AddExpenseType2Screen')
...
export default ExpenseType2ListScreen
