...
const AddPreviousPurchaseScreen = ({ route, navigation }) => {
            ...
            <ScrollView
                ...
                <KeyboardAvoidingView enabled>
                    ...
                    <View style={styles.ErrorSectionStyle}>
                        {errors.productName && <Text style={styles.ErrorMesage}>Purchase Name is required!</Text>}
                    </View>
                    <View style={styles.SectionStyle}>
                        <Controller
                            control={control}
...
export default AddPreviousPurchaseScreen
