...
const SalesHistoryScreen = ({ navigation }) => {
    ...
    useEffect(async () => {
        AsyncStorage.getItem('id').then(value => {
            ...
            GetSalesHistory(value, currentDate)

        });
    }, []);

    const GetSalesHistory = (value, dateValue) => {
        setLoading(true);
        fetch(`http://bustle.ticketplanet.ng/GetSalesHistoryWeek/${value}/${dateValue}`, {
            method: 'Get',
            headers: {
