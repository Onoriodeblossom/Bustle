...
import { ExpandableSaleUpdateList } from '../components/ExpandableSaleUpdateList';
import AsyncStorage from '@react-native-community/async-storage';

const SalesUpdateScreen = ({ navigation }) => {
...
export default SalesUpdateScreen
