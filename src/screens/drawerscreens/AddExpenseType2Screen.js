...
const AddExpenseType2Screen = ({ route, navigation }) => {
        ...
        AsyncStorage.getItem('id').then(value => {
            ...
            if (!isAddMode) {
                ...
                fetch(`http://bustle.ticketplanet.ng/GetExpenseById/${id}/${value}`, {
                    ...
                    .then(responseJson => {
                        setLoading(false);
                        const fields = ['expenseTypeId', 'amount'];
    ...
    const GetAllExpenseType = (userId) => {
        fetch(`http://bustle.ticketplanet.ng/GetExpenseType/${userId}`, {
            method: 'Get',
            headers: {
                'Content-Type': 'application/json',
            },
            ...
            <ScrollView
                ...
                <KeyboardAvoidingView enabled>
                        ...
                        <Controller
                            ...
                            render={({ field: { onChange, onBlur, value } }) => (
                                ...
                                >
                                    ...
                                    {expenseTypeList.map((item, key) =>
                                        <Picker.Item label={item.expenseTypeName} value={item.id.toString()} key={key} />
                                    )}
                                </Picker>
                            )}
                            name="expenseTypeId"
                    ...
                    <View style={styles.ErrorSectionStyle}>
                        {errors.expenseTypeId && <Text style={styles.ErrorMesage}>Expense Type is required!</Text>}
                    </View>
...
export default AddExpenseType2Screen
